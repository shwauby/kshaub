...
Class PMS_Form_Handler {
    ...
    public static function register_form() {
         ...
         *
         */
        $gdpr_settings = get_option('pms_gdpr_settings');
    ...
    public static function register_user( $user_data = array(), $redirect = false ) {
        ...
        /* GDPR accept */
        if ( !empty($user_id) && isset( $_POST['user_consent'] ) && $_POST['user_consent'] === 1 ) {
        ...
        if( $payment_response ) {
            ...
            switch( $form_location ) {
                ...
                case 'renew_subscription':
                    ...
                    pms_add_member_subscription_log( $subscription->id, 'subscription_renewed_manually' );
