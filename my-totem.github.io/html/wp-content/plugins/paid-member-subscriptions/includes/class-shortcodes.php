    ...
    public static function member_account( $args ) {
        ...
        if ( $active_tab == 'subscriptions' ) {
            ...
            if( defined('PROFILE_BUILDER') ){
                ...
                }elseif ( isset($pms_general_settings['edit_profile_shortcode']) && $pms_general_settings['edit_profile_shortcode'] == 'wppb-default-edit-profile' ){
                    echo do_shortcode( '[wppb-edit-profile]' );
                } elseif( isset($pms_general_settings['edit_profile_shortcode']) ){
