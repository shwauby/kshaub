...
<div class="uimrow" id="paidgroup">
  <div class="uimfield">
    <?php _e( 'Membership Charge','profilegrid-user-profiles-groups-and-communities' ); ?>
  </div>
  <div class="uiminput">
...
<div class="childfieldsrow" id="paidgrouphtml" style=" <?php if(!empty($group_options) && isset($group_options['is_paid_group']) && $group_options['is_paid_group']==1){echo 'display:block;';} else { echo 'display:none;';} ?>">
  <div class="uimrow">
    <div class="uimfield">
      <?php _e( 'Group Membership Price','profilegrid-user-profiles-groups-and-communities' ); ?>
    </div>
...
<div class="uimrow">
  <div class="uimfield">
    <?php _e( 'Group Registration Form','profilegrid-user-profiles-groups-and-communities' ); ?>
  </div>
  <div class="uiminput">
      <select name="group_options[pg_rm_form]" id="pg_rm_form">
          <option value="0"><?php _e('ProfileGrid Default Group Form','profilegrid-user-profiles-groups-and-communities');?></option>
          <?php 
  ...
  <div class="uimnote"><?php echo sprintf(__("Select a user registration form for this group. ProfileGrid Default Group Form option will automatically create a form using profile fields in this group. Other form options are fetched from RegistrationMagic. For more information <a href='%s' target='_blank'>CLICK HERE</a>","profilegrid-user-profiles-groups-and-communities"),$pg_url);?><a target="_blank" href="https://profilegrid.co/documentation/new-group-or-edit-group/"><?php _e('More','profilegrid-user-profiles-groups-and-communities');?></a></div>
</div>
