...
if(filter_input(INPUT_POST,'submit_settings'))
{
	...
	if (!wp_verify_nonce($retrieved_nonce, 'save_upload_settings' ) ) die( __('Failed security check','profilegrid-user-profiles-groups-and-communities') );
...
<div class="uimagic">
  <form name="pm_upload_settings" id="pm_upload_settings" method="post">
    ...
    <div class="content">
      <div class="uimheader">
        <?php _e( 'Uploads','profilegrid-user-profiles-groups-and-communities' ); ?>
      </div>
      ...
      <div class="uimrow">
        <div class="uimfield">
          <?php _e( 'Profile Image Maximum File Size (in bytes)','profilegrid-user-profiles-groups-and-communities' ); ?>
        </div>
        <div class="uiminput">
      ...
      <div class="uimrow">
        <div class="uimfield">
          <?php _e( 'Cover Image Maximum File Size (in bytes)','profilegrid-user-profiles-groups-and-communities' ); ?>
        </div>
        <div class="uiminput">
      ...
      <div class="uimrow">
        <div class="uimfield">
          <?php _e( 'Image Quality','profilegrid-user-profiles-groups-and-communities' ); ?>
        </div>
        <div class="uiminput">
        ...
        <div class="uimnote"><?php _e('Set quality of images being rendered inside ProfileGrid. A lower quality can improve load times. Values vary between 1 to 100.','profilegrid-user-profiles-groups-and-communities');?></div>
      </div>
        
      <div class="uimrow">
        <div class="uimfield">
          <?php _e( 'Profile Image Minimum Width','profilegrid-user-profiles-groups-and-communities' ); ?>
        </div>
        <div class="uiminput">
        ...
        <div class="uimnote"><?php _e('Set a minimum width (in pixels) for the photos users upload as their profile image.','profilegrid-user-profiles-groups-and-communities');?></div>
      </div>
        
      <div class="uimrow">
        <div class="uimfield">
          <?php _e( 'Cover Image Minimum Width','profilegrid-user-profiles-groups-and-communities' ); ?>
        </div>
        <div class="uiminput">
