...
<div class="pmagic"> 
  ...
  <div class="pm-user-area">
    ...
    <?php 
        ...
        echo '<div class="pg-uim-notice">'.__('This profile is not yet associated with any parent profile group. To make it visible please associate it with a group first.','profilegrid-user-profiles-groups-and-communities').'</div>';
    endif;
    ?>
