...
<div class="uimagic">
    ...
    <div class="content">
      ...
      <div class="uimrow">
        ...
        <div class="uimnote"><?php _e("Turns on reCAPTCHA on all registration forms.",'profilegrid-user-profiles-groups-and-communities');?><a target="_blank" href="https://profilegrid.co/documentation/security-settings/"><?php _e('More','profilegrid-user-profiles-groups-and-communities');?></a></div>
      </div>
