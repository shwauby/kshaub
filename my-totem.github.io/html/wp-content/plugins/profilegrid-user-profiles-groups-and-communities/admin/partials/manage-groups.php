  ...
  <div class="pmagic-cards">
    <div class="pm-card">
      <div class="pm-new-form">
        ...
        <input type="submit" value="<?php _e('Add New Group','profilegrid-user-profiles-groups-and-communities');?>" name="submit_group" id="submit_group" onclick="return check_validation()" />
      </div>
    </div>
    <?php if(!empty($groups)):
    ...
    <div class="pm-card">
      ...
      <?php endif;?>
      <div class="pm-form-shortcode-row">[PM_Group <?php echo 'ID="'.$group->id.'';?>"]</div>
      <div class="pm-form-links">
        <div class="pm-form-row pm-group-setting"><a href="admin.php?page=pm_add_group&id=<?php echo $group->id;?>"><?php _e('Settings','profilegrid-user-profiles-groups-and-communities');?></a></div>
        <div class="pm-form-row pm-group-fields"><a href="admin.php?page=pm_profile_fields&gid=<?php echo $group->id;?>"><?php _e('Fields','profilegrid-user-profiles-groups-and-communities');?></a></div>
      </div>
    </div>
    <?php endforeach;?>
    <?php else: ?>
...
<div class="pg-side-banner">
    ...
    <div class="pg-sidebanner-image">
        <img src="<?php echo $path;?>images/pg-logo.png">
        </div>
    
    <div class="pg-side-banner-mg-logo"><img src="<?php echo $path;?>images/mg-logo.png"></div>
...
<div class="pg-side-banner-buttons">
    ...
    <div class="pg-uim-notice-wrap pg-groups-alert">
        <div class="pg-uim-notice"><?php _e('Note: Groups are optional. If you do not wish to create multiple groups, you can use the default group for all user profiles and sign ups.','profilegrid-user-profiles-groups-and-communities');?></div>
         </div>
