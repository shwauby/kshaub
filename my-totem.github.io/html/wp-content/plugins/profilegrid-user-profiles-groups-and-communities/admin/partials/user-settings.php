...
if(filter_input(INPUT_POST,'submit_settings'))
{
	...
	if (!wp_verify_nonce($retrieved_nonce, 'save_user_settings' ) ) die( __('Failed security check','profilegrid-user-profiles-groups-and-communities') );
...
<div class="uimagic">
  <form name="pm_user_settings" id="pm_user_settings" method="post">
    ...
    <div class="content">
      <div class="uimheader">
        <?php _e( 'User Accounts','profilegrid-user-profiles-groups-and-communities' ); ?>
      </div>
      ...
      <div class="uimrow">
        <div class="uimfield">
          <?php _e( 'WP Registration Auto Approval:','profilegrid-user-profiles-groups-and-communities' ); ?>
        </div>
        <div class="uiminput">
        ...
        <div class="uimnote"><?php _e("Automatically activate user accounts after registration form is submitted. Keep this setting off if you want to manually approve each registering user.",'profilegrid-user-profiles-groups-and-communities');?><a target="_blank" href="https://profilegrid.co/documentation/user-accounts-settings/"><?php _e('More','profilegrid-user-profiles-groups-and-communities');?></a></div>
      </div>
      ...
      <div class="childfieldsrow" id="enable_auto_approval_html" style=" <?php if($dbhandler->get_global_option_value('pm_auto_approval',0)==1){echo 'display:block;';} else { echo 'display:none;';} ?>">
             <div class="uimrow">
                <div class="uimfield">
                  <?php _e( 'Send user Activation link in email:','profilegrid-user-profiles-groups-and-communities' ); ?>
                </div>
                <div class="uiminput">
                ...
                <div class="uimnote"><?php _e('Send an activation link to user in an email. Keep this setting "off", if you want to automatically approve each registered user.','profilegrid-user-profiles-groups-and-communities');?></div>
             </div>
          
          
          <div class="childfieldsrow" id="send_user_activation_email_html" style=" <?php if($dbhandler->get_global_option_value('pm_send_user_activation_link',0)==1){echo 'display:block;';} else { echo 'display:none;';} ?>">
                ...
                <div class="uimrow">
                    ...
                    <div class="uiminput">
                     <input type="text" name="pm_activation_email_subject" id="pm_activation_email_subject" value="<?php echo $dbhandler->get_global_option_value('pm_activation_email_subject',__('Your Registration is Pending Approval','profilegrid-user-profiles-groups-and-communities'));?>" />
                      
                    </div>
                    <div class="uimnote"><?php _e('Subject of the email sent to the user.','profilegrid-user-profiles-groups-and-communities');?></div>
                 </div>
                <?php
		...
		$message .= __( 'Thanks!','profilegrid-user-profiles-groups-and-communities' ) . "<br />\r\n";
                ...
                <div class="uimrow">
                    ...
                    <div class="uimnote"><?php _e('Content of the email sent to the user.','profilegrid-user-profiles-groups-and-communities');?></div>
                 </div>
       ...
       <div class="uimrow">
        <div class="uimfield">
          <?php _e( 'Display Password Change','profilegrid-user-profiles-groups-and-communities' ); ?>
        </div>
        <div class="uiminput">
        ...
        <div class="uimnote"><?php _e("Display an option for logged in users on their profile pages to change their passwords.",'profilegrid-user-profiles-groups-and-communities');?></div>
      </div>

        <div class="uimrow">
        <div class="uimfield">
          <?php _e( 'Show Privacy Options','profilegrid-user-profiles-groups-and-communities' ); ?>
        </div>
        <div class="uiminput">
        ...
        <div class="uimnote"><?php _e("Display a tab for modifying privacy settings in user account section of user profiles.",'profilegrid-user-profiles-groups-and-communities');?></div>
      </div>
        
         <div class="uimrow">
        <div class="uimfield">
          <?php _e( 'Allow Profile Deletion','profilegrid-user-profiles-groups-and-communities' ); ?>
        </div>
        <div class="uiminput">
        ...
        <div class="uimnote"><?php _e("Allow users to delete their own profiles. If selected, users will see this option in user account section of their user profiles.",'profilegrid-user-profiles-groups-and-communities');?></div>
      </div>
      ...
      <div class="childfieldsrow" id="pm_show_delete_profile_html" style=" <?php if($dbhandler->get_global_option_value('pm_show_delete_profile',0)==1){echo 'display:block;';} else { echo 'display:none;';} ?>">
             <div class="uimrow">
                <div class="uimfield">
                  <?php _e( 'Account Deletion Warning Text','profilegrid-user-profiles-groups-and-communities' ); ?>
                </div>
                <div class="uiminput">
                ...
                <div class="uimnote"><?php _e('Users will see this text as warning when they try to delete their profiles.','profilegrid-user-profiles-groups-and-communities');?></div>
             </div>
      </div>
      
        <div class="uimrow">
        <div class="uimfield">
          <?php _e( 'Allow Email Change','profilegrid-user-profiles-groups-and-communities' ); ?>
        </div>
        <div class="uiminput">
        ...
        <div class="uimnote"><?php _e("Allow users to change their registered emails when editing their profiles.",'profilegrid-user-profiles-groups-and-communities');?></div>
      </div>
        
        <div class="uimrow">
        <div class="uimfield">
          <?php _e( 'Allow Users to Hide Their Profiles from Directory and Groups','profilegrid-user-profiles-groups-and-communities' ); ?>
        </div>
        <div class="uiminput">
        ...
        <div class="uimnote"><?php _e("Users can opt not to display their profile cards in user directories and groups.",'profilegrid-user-profiles-groups-and-communities');?></div>
      </div>
        
        <div class="uimrow">
        <div class="uimfield">
          <?php _e( 'Default Profile Image','profilegrid-user-profiles-groups-and-communities' ); ?>
        </div>
        <div class="uiminput">
              
          <input id="pm_default_avatar" type="hidden" name="pm_default_avatar" class="icon_id" value="<?php echo $pm_default_avatar; ?>" />
          <input id="field_icon_button" name="field_icon_button" class="button pm_choose_image_btn" type="button" value="<?php _e('Upload Image','profilegrid-user-profiles-groups-and-communities');?>" />
          <br />
        ...
        <div class="uimnote"><?php _e("Displays this image when a user has not selected or removed his/ her profile image.",'profilegrid-user-profiles-groups-and-communities');?></div>
      </div>
        
        
        <div class="uimrow">
        <div class="uimfield">
          <?php _e( 'Default Cover Image','profilegrid-user-profiles-groups-and-communities' ); ?>
        </div>
        <div class="uiminput">
          ...
          <input id="field_cover_icon_button" name="field_cover_icon_button" class="button" type="button" value="<?php _e('Upload Image','profilegrid-user-profiles-groups-and-communities');?>" />
          <br />
        ...
        <div class="uimnote"><?php _e("Displays this image when a user has not selected or removed his/ her cover image.",'profilegrid-user-profiles-groups-and-communities');?></div>
      </div>
