...
if(filter_input(INPUT_POST,'submit_settings'))
{
	...
	if (!wp_verify_nonce($retrieved_nonce, 'save_friends_settings' ) ) die( __('Failed security check','profilegrid-user-profiles-groups-and-communities') );
...
<div class="uimagic">
  <form name="pm_user_settings" id="pm_user_settings" method="post">
    ...
    <div class="content">
      <div class="uimheader">
        <?php _e( 'Friends Integration','profilegrid-user-profiles-groups-and-communities' ); ?>
      </div>
      ...
      <div class="uimrow">
        <div class="uimfield">
          <?php _e( 'Allow/ Disallow Making Friends:','profilegrid-user-profiles-groups-and-communities' ); ?>
        </div>
        <div class="uiminput">
        ...
        <div class="uimnote"><?php _e('Toggle Friends functionality on/ off.','profilegrid-user-profiles-groups-and-communities');?><a target="_blank" href="https://profilegrid.co/documentation/friends-system/"><?php _e('More','profilegrid-user-profiles-groups-and-communities');?></a></div>
      </div> 
      ...
      <div class="uimrow">
        <div class="uimfield">
          <?php _e( 'Allow sending request to person who rejected earlier request:','profilegrid-user-profiles-groups-and-communities' ); ?>
        </div>
        <div class="uiminput">
        ...
        <div class="uimnote"><?php _e('Allow resending of friend requests to users who have earlier rejected the request.','profilegrid-user-profiles-groups-and-communities');?></div>
      </div>
      ...
      <div class="uimrow">
        <div class="uimfield">
          <?php _e( 'After how many days?','profilegrid-user-profiles-groups-and-communities' ); ?>
        </div>
        <div class="uiminput">
        ...
        <div class="uimnote"><?php _e('Define number of days after which a user can resend friend request to another user who has earlier deleted his/ her request.','profilegrid-user-profiles-groups-and-communities');?></div>
      </div>
      </div>
