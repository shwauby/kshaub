  ...
  <form name="pm_user_settings" id="pm_user_settings" method="post">
    ...
    <div class="content">
      ...
      <div class="uimsubheader">
        ...
        <div class="uimnote"><?php _e("Turn on social blogging for your users. Make sure you have a page with User Blog shortcode for users to submit posts.",'profilegrid-user-profiles-groups-and-communities');?><a target="_blank" href="https://profilegrid.co/documentation/user-blogs/"><?php _e('More','profilegrid-user-profiles-groups-and-communities');?></a></div>
      </div>
