...
if(filter_input(INPUT_POST,'submit_section'))
{
	...
	if (!wp_verify_nonce($retrieved_nonce, 'save_pm_add_section' ) ) die( __('Failed security check','profilegrid-user-profiles-groups-and-communities') );
...
<div class="uimagic">
  <form name="pm_add_section" id="pm_add_section" method="post">
    ...
    <div class="content">
      ...
      <?php else: ?>
      <div class="uimheader">
        <?php _e( 'Edit Section','profilegrid-user-profiles-groups-and-communities' ); ?>
      </div>
      <?php endif; ?>
      ...
      <div class="uimrow">
        ...
        <div class="uimnote"><?php _e('Enter a new name for this Profile Section.','profilegrid-user-profiles-groups-and-communities');?></div>
      </div>
      ...
      <div class="uimrow">
        ...
        <div class="uimnote"><?php _e('Move this Profile section to another Group.','profilegrid-user-profiles-groups-and-communities');?></div>
      </div>
