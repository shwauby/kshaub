...
class PM_Custom_Fields {
    ...
    public function pm_get_custom_login_field_username($textdomain = '') {
        ...
        <div class="pm-col">
            ...
            <div class="pm-field-lable">
                <label for="user_login"><?php _e('Username or Email','profilegrid-user-profiles-groups-and-communities'); ?></label>
            </div>
    ...
    public function pm_get_custom_login_field_password($textdomain = '') {
        ...
        <div class="pm-col">
            <div class="pm-field-lable">
                <label for="user_pass"><?php _e('Password','profilegrid-user-profiles-groups-and-communities'); ?></label>
            </div>
            <div class="pm-field-input pm_required">
    ...
    public function pm_get_custom_login_field_remember_me($textdomain = '') {
        ...
        <div class="pm-col">
            ...
            <div class="pm-field-input">
                ...
                <label for="remember_me"><?php _e('Remember Me','profilegrid-user-profiles-groups-and-communities'); ?></label>
                <div class="errortext" style="display:none;"></div>
            </div>
        </div>
        <?php
            ...
            <div class="pm-field-input pm_fileinput <?php if ($row->is_required == 1) echo 'pm_repeat_required'; ?>">
                ...
                <div class="pm_repeat">
                    ...
                    <?php if ($dbhandler->get_global_option_value('pm_allow_multiple_attachments') == 1): ?>
                        <a class="add"><span onClick="pm_add_repeat(this)"><?php _e('Add','profilegrid-user-profiles-groups-and-communities'); ?></span></a>
                        <a class="removebutton"><span class="remove" onClick="pm_remove_repeat(this)"><?php _e('Remove','profilegrid-user-profiles-groups-and-communities'); ?></span></a>
                    <?php endif; ?>
                    <div class="errortext" style="display:none;"></div>
                </div>
    ...
    public function pm_get_custom_form_field_user_avatar($row, $value = '', $textdomain = '') {
        ...
        {
            $message = sprintf( __( 'Size Restrictions: Please make sure the image size is equal to or larger than %d by %d pixels.','profilegrid-user-profiles-groups-and-communities' ),$pg_profile_photo_minimum_width ,$pg_profile_photo_minimum_width);
        }
        else
        {
            $message = sprintf( __( 'Size Restrictions: Please make sure the image size is equal to or larger than %d by %d pixels and does not exceeds total size of %d bytes.','profilegrid-user-profiles-groups-and-communities' ),$pg_profile_photo_minimum_width ,$pg_profile_photo_minimum_width,$pg_profile_image_max_file_size);
        }
        if ($value != '')
            $row->is_required = 0;
        if ($row->field_options != "")
            ...
            <div class="pm-field-input <?php if ($row->is_required == 1) echo 'pm_repeat_required'; ?>">
                <?php foreach ($values as $val): ?>
                    <div class="pm_repeat">
                        ...
                        <a class="add"><span onClick="pm_add_repeat(this)"><?php _e('Add','profilegrid-user-profiles-groups-and-communities'); ?></span></a><a class="removebutton"><span class="remove" onClick="pm_remove_repeat(this)"><?php _e('Remove','profilegrid-user-profiles-groups-and-communities'); ?></span></a>
                        <div class="errortext" style="display:none;"></div>
                    </div>
        <?php endforeach; ?>
        ...
        <div class="pm-col">
            ...
            <div class="pm-field-input <?php if ($row->is_required == 1) echo 'pm_radiorequired'; ?>">
                <div class="pmradio pm_gender">
                    <div class="pm-radio-option"><input title="<?php echo esc_attr($row->field_desc); ?>" type="radio" class="<?php if (!empty($field_options)) echo esc_attr($field_options['css_class_attribute']); ?>" id="<?php echo esc_attr($row->field_key); ?>" name="<?php echo esc_attr($row->field_key); ?>" value="<?php _e('Male', 'profilegrid-user-profiles-groups-and-communities') ?>" <?php if ($value == 'Male') echo 'checked'; ?>> <?php _e('Male', 'profilegrid-user-profiles-groups-and-communities') ?></div>
                    <div class="pm-radio-option"><input title="<?php echo esc_attr($row->field_desc); ?>" type="radio" class="<?php if (!empty($field_options)) echo esc_attr($field_options['css_class_attribute']); ?>" id="<?php echo esc_attr($row->field_key); ?>" name="<?php echo esc_attr($row->field_key); ?>" value="<?php _e('Female', 'profilegrid-user-profiles-groups-and-communities') ?>" <?php if ($value == 'Female') echo 'checked'; ?>> <?php _e('Female', 'profilegrid-user-profiles-groups-and-communities') ?></div>
                    <div class="pm-radio-option"><input title="<?php echo esc_attr($row->field_desc); ?>" type="radio" class="<?php if (!empty($field_options)) echo esc_attr($field_options['css_class_attribute']); ?>" id="<?php echo esc_attr($row->field_key); ?>" name="<?php echo esc_attr($row->field_key); ?>" value="<?php _e('Others', 'profilegrid-user-profiles-groups-and-communities') ?>" <?php if ($value == 'Others') echo 'checked'; ?>> <?php _e('Others', 'profilegrid-user-profiles-groups-and-communities') ?></div>
                </div>
                <div class="errortext" style="display:none;"></div>
            </div>
        </div>
 ...
 <div id="locationField">
      <input id="autocomplete" placeholder="<?php _e('Enter your address','profilegrid-user-profiles-groups-and-communities');?>"
             onFocus="" type="text"></input>
    </div>
<div>
     <input id="autocomplete" placeholder="<?php _e('Enter your address','profilegrid-user-profiles-groups-and-communities');?>" onFocus="" type="text"></input>
     <div>
         <input class="field" id="street_number" placeholder="<?php _e('street','profilegrid-user-profiles-groups-and-communities');?>" disabled="true"></input>
         <input class="field" id="route" placeholder="<?php _e('route','profilegrid-user-profiles-groups-and-communities');?>" disabled="true"></input>
         <input class="field" id="locality" placeholder="<?php _e('city','profilegrid-user-profiles-groups-and-communities');?>" disabled="true"></input>
         <input class="field" id="administrative_area_level_1" placeholder="<?php _e('state','profilegrid-user-profiles-groups-and-communities');?>" disabled="true"></input>
          <input class="field" id="postal_code" placeholder="<?php _e('zip code','profilegrid-user-profiles-groups-and-communities');?>" disabled="true"></input>
          <input class="field" id="country" placeholder="<?php _e('Country','profilegrid-user-profiles-groups-and-communities');?>" disabled="true"></input>     
     </div>
</div>
