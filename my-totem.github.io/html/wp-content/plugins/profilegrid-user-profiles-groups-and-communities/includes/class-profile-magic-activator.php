...
class Profile_Magic_Activator {
	...
	public function create_pages() {
		$dbhandler = new PM_DBhandler;
                $pmrequest = new PM_request;
		$pages['PM_Registration'] = array('post_type' => 'page','post_title' => __('Registration','profilegrid-user-profiles-groups-and-communities'),'post_status' => 'publish','post_name' => '','post_content' => '[PM_Registration id="1"]');
		$pages['PM_Group'] = array('post_type' => 'page','post_title' => __('Default User Group','profilegrid-user-profiles-groups-and-communities'),'post_status' => 'publish','post_name' => '','post_content' => '[PM_Group id="1"]');
		$pages['PM_Groups'] = array('post_type' => 'page','post_title' => __('All Groups','profilegrid-user-profiles-groups-and-communities'),'post_status' => 'publish','post_name' => '','post_content' => '[PM_Groups]');
		$pages['PM_Login'] = array('post_type' => 'page','post_title' => __('Login','profilegrid-user-profiles-groups-and-communities'),'post_status' => 'publish','post_name' => '','post_content' => '[PM_Login]');
		$pages['PM_Profile'] = array('post_type' => 'page','post_title' => __('My Profile','profilegrid-user-profiles-groups-and-communities'),'post_status' => 'publish','post_name' => '','post_content' => '[PM_Profile]');
		$pages['PM_Forget_Password'] = array('post_type' => 'page','post_title' => __('Forgot Password','profilegrid-user-profiles-groups-and-communities'),'post_status' => 'publish','post_name' => '','post_content' => '[PM_Forget_Password]');
		$pages['PM_Add_Blog'] = array('post_type' => 'page','post_title' => __('Submit New Blog Post','profilegrid-user-profiles-groups-and-communities'),'post_status' => 'publish','post_name' => '','post_content' => '[PM_Add_Blog]');
                $pages['PM_Search'] = array('post_type' => 'page','post_title' => __('Search Users','profilegrid-user-profiles-groups-and-communities'),'post_status' => 'publish','post_name' => '','post_content' => '[PM_Search]');
                $pages['PM_User_Blogs'] = array('post_type' => 'page','post_title' => __('User Blogs','profilegrid-user-profiles-groups-and-communities'),'post_status' => 'publish','post_name' => '','post_content' => '[PM_User_Blogs]');
		// The Query
		...
		if($dbhandler->pm_count('GROUPS')==0) {
			$data = array(
                            ...
                            'group_desc'=>__('This the default user group. All existing registered users are automatically assigned this group. Groups can be modified or deleted by the admin.','profilegrid-user-profiles-groups-and-communities'),
			...
			$section_data = array('gid'=>$gid,'section_name'=>__('Personal Details','profilegrid-user-profiles-groups-and-communities'),'ordering'=>$gid);
