...
if (defined('ABSPATH') && !class_exists('kt_Central_Palette')) {
    define('KT_CENTRAL_PALETTE', '1.14.2');
        ...
        public function init_integrations() {
            ...
            if ($this->supports('elementor') && get_option(self::ELEMENTOR)) {
                if (version_compare(ELEMENTOR_VERSION, '2.8', '>=')) {
                    add_filter('elementor/editor/localize_settings', array($this, 'elementor_2_8_integration'), 100);
                } else {
...
';
        ...
        /**
         * Elementor integration since Elementor version 2.8
         * @since 1.14.2
         * @param array $config
         * @return array
         */
        public function elementor_2_8_integration($config) {
            $config['schemes'] = array(
                'items' => array(
                    'color-picker' => array(
                        'items' => $this->elementor_palette('2.8'),
                    ),
                ),
            );
            return $config;
         ...
         * @return array
         */
        public function elementor_palette($version = false) {
