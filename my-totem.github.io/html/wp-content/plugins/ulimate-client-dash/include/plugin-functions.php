...
add_action('wp_dashboard_setup', 'remove_dashboard_meta', 20);
add_action('wp_user_dashboard_setup', 'remove_dashboard_meta', 20);


// Function to remove help tab from the WordPress dashboard
function ucd_remove_help_tab( $old_help, $screen_id, $screen ){
...
add_filter( 'contextual_help', 'ucd_remove_help_tab', 999, 3 );
    ...
    if ( is_user_logged_in() ) { ?>
        <style>
            ...
            if ( !empty($ucd_dashboard_admin_bar_text_color) ) { ?>
                #wpadminbar a.auto-fold #adminmenu div.wp-menu-image,
            ...
            $ucd_dashboard_accent = get_option('ucd_dashboard_accent');
            if ( !empty($ucd_dashboard_accent) ) { ?>
                #adminmenu li.wp-has-current-submenu:hover div.wp-menu-image:before, #adminmenu li.current a.menu-top:hover div.wp-menu-image:before, #adminmenu li.current a.menu-top:hover,
