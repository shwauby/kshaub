				...
				?>
						...
						<div class="ucd-form-message"><?php settings_errors('ucd-notices'); ?></div>
								...
								<th><h2 class="ucd-inner-title"><?php _e( 'Admin Bar', 'ultimate-client-dash' ); ?></h2></th>
											...
											<td><input type="text" placeholder="" class="color-field" name="ucd_dashboard_admin_bar_text_color" value="<?php echo esc_attr( get_option('ucd_dashboard_admin_bar_text_color') ?: '#eeeeee' ); ?>" size="50" />
											<p>
								...
								<th><h2 class="ucd-inner-title"><?php _e( 'Advanced Settings', 'ultimate-client-dash' ); ?></h2></th>
											...
											<tr class="ucd-pro-version">
											<th><?php _e( 'Dashboard Custom CSS', 'ultimate-client-dash' ); ?>
											<p>Enter your dashboard custom CSS here.</p>
											</th>
