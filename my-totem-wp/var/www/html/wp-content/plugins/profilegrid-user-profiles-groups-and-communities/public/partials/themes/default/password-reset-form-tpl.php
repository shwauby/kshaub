...
?>
    ...
    <form name="resetpassform" id="resetpassform" action="<?php echo site_url( 'wp-login.php?action=resetpass' ); ?>" method="post" autocomplete="off">
      ...
      <input type="password" name="pass1" id="pass1" class="input" size="20" value="" autocomplete="off" placeholder="<?php _e('New password','profilegrid-user-profiles-groups-and-communities');?>" required="required" />
      <input type="password" name="pass2" id="pass2" class="input" size="20" value="" autocomplete="off" placeholder="<?php _e('Repeat new password','profilegrid-user-profiles-groups-and-communities');?>" required="required" />
      <div class="pm-login-box-bottom-container">
        <input type="submit" name="submit" id="resetpass-button" class="button" value="<?php _e( 'Reset Password','profilegrid-user-profiles-groups-and-communities' ); ?>" />
      </div>
    </form>
