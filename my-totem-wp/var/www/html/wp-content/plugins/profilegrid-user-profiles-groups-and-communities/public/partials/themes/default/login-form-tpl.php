...
if ( is_user_logged_in()) : ?>
	...
	?> 
	  <div class="pm-login-header pm-dbfl pm-bg pm-pad10 pm-border-bt">
		  <h3><?php _e( 'You have successfully logged in.','profilegrid-user-profiles-groups-and-communities' );?></h3>
...
<!-----Form Starts----->
  ...
  <?php wp_nonce_field('pm_login_form'); ?>
            ...
            <div class="pm-login-box-bottom-container pm-dbfl pm-bg pm-border">
                <input type="submit" value="<?php _e('Login','profilegrid-user-profiles-groups-and-communities');?>" name="login_form_submit" class="pm-difl">
