...
{
	echo '<div id="pg-friends-requests-sent-container"><p class="pm-no-result-found">'.__('No new sent requests','profilegrid-user-profiles-groups-and-communities').'</p></div>';
