<div class="uimrow">
        <div class="uimfield">
          <?php _e('Apply custom access settings?','profilegrid-user-profiles-groups-and-communities'); ?>
        </div>
        <div class="uiminput">
 ...
 <div class="childfieldsrow" id="pm_access_html" style=" <?php if(get_post_meta($post->ID,'pm_enable_custom_access',true)!=1)echo 'display:none';else'display:block';?>" >
      <div class="uimrow">
        <div class="uimfield">
          <?php _e( 'Content Availability','profilegrid-user-profiles-groups-and-communities'); ?>
        </div>
        <div class="uiminput">
           <ul class="uimradio">
              <li>
              ...
              <li>
                ...
                <?php _e("Members of Author's Groups",'profilegrid-user-profiles-groups-and-communities' ); ?>
              </li>
             <li>
              ...
              <li>
                ...
                <?php _e('Content accessible to Only Me','profilegrid-user-profiles-groups-and-communities' ); ?>
              </li>
            </ul>
        </div>
      </div>
   ...
   <div class="childfieldsrow" id="pm_group_html" style=" <?php if(get_post_meta($post->ID,'pm_content_access',true)!=2)echo 'display:none';else'display:block';?>">
      <div class="uimrow">
        <div class="uimfield">
          <?php _e( 'Select the User Group that can see this content?','profilegrid-user-profiles-groups-and-communities' ); ?>
        </div>
        <div class="uiminput">
          <?php
          ...
          <option value="all" <?php selected(get_post_meta ($post->ID,'pm_content_access_group',true),'all');?>><?php _e('All Registered Users','profilegrid-user-profiles-groups-and-communities');?></option>
