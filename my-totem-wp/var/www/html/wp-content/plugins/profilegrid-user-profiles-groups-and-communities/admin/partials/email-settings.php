...
if(filter_input(INPUT_POST,'submit_settings'))
{
	...
	if (!wp_verify_nonce($retrieved_nonce, 'save_email_settings' ) ) die( __('Failed security check','profilegrid-user-profiles-groups-and-communities') );
...
<div class="uimagic">
  <form name="pm_security_settings" id="pm_security_settings" method="post">
    ...
    <div class="content">
      <div class="uimheader">
        <?php _e( 'Email Notification','profilegrid-user-profiles-groups-and-communities' ); ?>
      </div>
      ...
      <div class="uimrow">
        <div class="uimfield">
          <?php _e( 'Send Notification To Site Admin:','profilegrid-user-profiles-groups-and-communities' ); ?>
        </div>
        <div class="uiminput">
          ...
          <div class="uimnote"><?php _e('The site administrator will be notified for each individual registration.','profilegrid-user-profiles-groups-and-communities');?><a target="_blank" href="https://profilegrid.co/documentation/email-notifications/"><?php _e('More','profilegrid-user-profiles-groups-and-communities');?></a></div>
      </div>
       ...
       <div class="uimrow" id="field_options_radio_html">
        <div class="uimfield">
          <?php _e( 'Or Define Recipients Manually:','profilegrid-user-profiles-groups-and-communities' ); ?>
        </div>
        <div class="uiminput">
	  ...
	  ?>
        ...
        <ul class="uimradio pg-add-other-options" id="pm_radio_field_other_option_html">
            <li><a class="pm_click_add_option pg-add-options" maxlength="0" onClick="add_pm_admin_email_option()" onKeyUp="add_pm_admin_email_option()"><?php _e('Click to add option','profilegrid-user-profiles-groups-and-communities');?></a></li>
      </ul>
        ...
        <div class="uimnote"><?php _e("If you want to notify multiple people about registrations, enter each one's email address individually.",'profilegrid-user-profiles-groups-and-communities');?></div>
           ...
           <div class="uimrow">
        <div class="uimfield">
          <?php _e( 'Account Needs Review Notification','profilegrid-user-profiles-groups-and-communities' ); ?>
        </div>
        <div class="uiminput">
        ...
        <div class="uimnote"><?php _e('Administrator will be notified about user account that needs review.','profilegrid-user-profiles-groups-and-communities');?></div>
      </div>
            <div class="childfieldsrow" id="pm_admin_account_review_notification_html" style=" <?php if($dbhandler->get_global_option_value('pm_admin_account_review_notification',0)==1){echo 'display:block;';} else { echo 'display:none;';} ?>">
                ...
                <div class="uimrow">
                    ...
                    <div class="uiminput">
                     <input type="text" name="pm_account_review_email_subject" id="pm_account_review_email_subject" value="<?php echo $dbhandler->get_global_option_value('pm_account_review_email_subject',__('New user awaiting review','profilegrid-user-profiles-groups-and-communities'));?>" />
           ...
           <div class="uimrow">
        <div class="uimfield">
          <?php _e( 'Account Deletion Notification','profilegrid-user-profiles-groups-and-communities' ); ?>
        </div>
        <div class="uiminput">
        ...
        <div class="uimnote"><?php _e('Administrator will be notified when a user deletes their account.','profilegrid-user-profiles-groups-and-communities');?></div>
      </div>
            ...
            <div class="uimrow">
                    ...
                    <div class="uiminput">
                     <input type="text" name="pm_account_delete_email_subject" id="pm_account_delete_email_subject" value="<?php echo $dbhandler->get_global_option_value('pm_account_delete_email_subject',__('Account deleted','profilegrid-user-profiles-groups-and-communities'));?>" />
       ...
       <div class="uimrow" id="from_email_name_html" style=" <?php if($dbhandler->get_global_option_value('pm_enable_smtp',0)==0){echo 'display:block;';} else { echo 'display:none;';} ?>">
        <div class="uimfield">
          <?php _e('From Email Name','profilegrid-user-profiles-groups-and-communities');?>
        </div>
        <div class="uiminput">
        ...
        <div class="uimnote"><?php _e("The <i>Sender's Name</i> inside the header of emails delivering notifications to the admin and the members.",'profilegrid-user-profiles-groups-and-communities');?></div>
      </div>
      ...
      <div class="uimrow" id="from_email_address_html" style=" <?php if($dbhandler->get_global_option_value('pm_enable_smtp',0)==0){echo 'display:block;';} else { echo 'display:none;';} ?>">
        <div class="uimfield">
          <?php _e('From Email Address','profilegrid-user-profiles-groups-and-communities');?>
        </div>
        <div class="uiminput">
      ...
      <div class="uimrow">
        <div class="uimfield">
          <?php _e( 'Enable SMTP:','profilegrid-user-profiles-groups-and-communities' ); ?>
        </div>
        <div class="uiminput">
        ...
        <div class="uimnote"><?php _e("Route emails from a dedicated email services instead of using your server's mail functionality. Allows a lot more control and better chances to avoid overzealous spam filters.",'profilegrid-user-profiles-groups-and-communities');?></div>
      </div>
      ...
      <div class="childfieldsrow" id="enable_smtp_html" style="<?php if($dbhandler->get_global_option_value('pm_enable_smtp',0)==1){echo 'display:block;';} else { echo 'display:none;';} ?>">
   	 ...
   	 <div class="uimrow">
        <div class="uimfield">
          <?php _e('SMTP Host','profilegrid-user-profiles-groups-and-communities');?>
        </div>
        <div class="uiminput">
          <input type="text" name="pm_smtp_host" id="pm_smtp_host" value="<?php echo $dbhandler->get_global_option_value('pm_smtp_host');?>">
          <div class="errortext"></div>
        </div>
        <div class="uimnote"><?php _e("Host Server name. For e.g.<i>smtp.gmail.com</i> if you wish to use Gmail. Consult your SMTP service provider for exact name.",'profilegrid-user-profiles-groups-and-communities');?></div>
      </div>
      
      
      <div class="uimrow">
        <div class="uimfield">
          <?php _e('Type of Encryption:','profilegrid-user-profiles-groups-and-communities');?>
        </div>
        <div class="uiminput">
         <select name="pm_smtp_encription" id="pm_smtp_encription">
           <option value="false" <?php selected($dbhandler->get_global_option_value('pm_smtp_encription'),'false'); ?>><?php _e('None','profilegrid-user-profiles-groups-and-communities');?></option>
           <option value="tls" <?php selected($dbhandler->get_global_option_value('pm_smtp_encription'),'tls'); ?>><?php _e('TLS','profilegrid-user-profiles-groups-and-communities');?></option>
           <option value="ssl" <?php selected($dbhandler->get_global_option_value('pm_smtp_encription'),'ssl'); ?>><?php _e('SSL','profilegrid-user-profiles-groups-and-communities');?></option>
      	 </select>
          <div class="errortext"></div>
        </div>
        <div class="uimnote"><?php _e('Encryption supported by your SMTP provider.','profilegrid-user-profiles-groups-and-communities');?></div>
      </div>
      
      <div class="uimrow">
        <div class="uimfield">
          <?php _e('SMTP Port:','profilegrid-user-profiles-groups-and-communities');?>
        </div>
        <div class="uiminput">
          <input type="text" name="pm_smtp_port" id="pm_smtp_port" value="<?php echo $dbhandler->get_global_option_value('pm_smtp_port');?>">
          <div class="errortext"></div>
        </div>
        <div class="uimnote"><?php _e('SMTP port. Usually number. For e.g. <i>465</i>','profilegrid-user-profiles-groups-and-communities');?></div>
      </div>
      
      <div class="uimrow">
        <div class="uimfield">
          <?php _e('SMTP Authentication:','profilegrid-user-profiles-groups-and-communities');?>
        </div>
        <div class="uiminput">
         <select name="pm_smtp_authentication" id="pm_smtp_authentication">
           <option value="true" <?php selected($dbhandler->get_global_option_value('pm_smtp_authentication'),'true'); ?>><?php _e('Yes','profilegrid-user-profiles-groups-and-communities');?></option>
           <option value="false" <?php selected($dbhandler->get_global_option_value('pm_smtp_authentication'),'false'); ?>><?php _e('No','profilegrid-user-profiles-groups-and-communities');?></option>
      	 </select>
          <div class="errortext"></div>
        </div>
        <div class="uimnote"><?php _e('Authentication supported by your SMTP service provider.','profilegrid-user-profiles-groups-and-communities');?></div>
      </div>
      
      <div class="uimrow">
        <div class="uimfield">
          <?php _e('SMTP Username:','profilegrid-user-profiles-groups-and-communities');?>
        </div>
        <div class="uiminput">
        ...
        <div class="uimnote"><?php _e('Your SMTP Username','profilegrid-user-profiles-groups-and-communities');?></div>
      </div>
      
      <div class="uimrow">
        <div class="uimfield">
          <?php _e('SMTP Password:','profilegrid-user-profiles-groups-and-communities');?>
        </div>
        <div class="uiminput">
        ...
        <div class="uimnote"><?php _e('Your SMTP Password','profilegrid-user-profiles-groups-and-communities');?></div>
      </div>
      ...
      <div class="uimrow">
        ...
        <div class="uimnote"><?php _e('The <i>From</i> name in your outgoing emails. For e.g. <i>John Doe</i>, <i>Acme Corp.</i> etc.','profilegrid-user-profiles-groups-and-communities');?></div>
      </div>
      ...
      <div class="uimrow">
        ...
        <div class="uimnote"><?php _e('Your SMTP Email Address','profilegrid-user-profiles-groups-and-communities');?></div>
      </div>
      
      <div class="uimrow">
        <div class="uimfield">
          <?php _e('Test Outgoing Connection:','profilegrid-user-profiles-groups-and-communities');?>
        </div>
        <div class="uiminput">
      ...
      <a class="cancel_button" onclick="pm_test_smtp_connection()"><?php _e('Test','profilegrid-user-profiles-groups-and-communities');?></a>
      <img src="<?php echo $path;?>images/ajax-loader.gif" style="display:none;">
      <span class="result"></span>
      </span>
          <div class="errortext"></div>
        </div>
        <div class="uimnote"><?php _e('For Testing Purpose Only. Once you have filled in all required SMTP details, you can enter an email address here, click "TEST" button and check if the email is sent successfully.','profilegrid-user-profiles-groups-and-communities');?></div>
      </div>
