...
if(filter_input(INPUT_POST,'submit_tmpl'))
{
	...
	if (!wp_verify_nonce($retrieved_nonce, 'save_pm_add_email_tmpl' ) ) die( __('Failed security check','profilegrid-user-profiles-groups-and-communities') );
...
<div class="uimagic">
  <form name="pm_add_email_template" id="pm_add_email_template" method="post">
    ...
    <div class="content">
      ...
      <?php else: ?>
      <div class="uimheader">
        <?php _e( 'Edit Template','profilegrid-user-profiles-groups-and-communities' ); ?>
      </div>
      <?php endif; ?>
      ...
      <div class="uimrow">
        <div class="uimfield">
          <?php _e('Title','profilegrid-user-profiles-groups-and-communities');?>
          <sup>*</sup></div>
        ...
        <div class="uimnote"><?php _e('Define a name for this template. Front-end user never sees this. Only for your reference.','profilegrid-user-profiles-groups-and-communities');?></div>
      </div>      
      <div class="uimrow">
        <div class="uimfield">
      ...
      <div class="uimrow">
        <div class="uimfield">
          <?php _e( 'Email Template','profilegrid-user-profiles-groups-and-communities' ); ?>
        </div>
        <div class="uiminput">
          <?php
	   if(!empty($row))
    ...
    'quicktags' => true
      ...
      <div class="buttonarea"> <a href="admin.php?page=pm_email_templates">
        ...
        <input type="submit" value="<?php _e('Save','profilegrid-user-profiles-groups-and-communities');?>" name="submit_tmpl" id="submit_tmpl" onClick="return add_group_validation()"  />
