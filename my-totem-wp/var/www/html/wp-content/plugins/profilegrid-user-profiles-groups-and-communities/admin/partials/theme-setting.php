...
<div class="uimagic">
    ...
    <div class="content">
      <div class="uimheader">
        <?php _e( 'Templates','profilegrid-user-profiles-groups-and-communities' ); ?>
      </div>
     <div class="uimsubheader">
         <?php /* _e('Note: Some templates are launched as Beta. If you are using a Beta template and come across any compatibility bug or issue with your theme, please report it <a href="https://profilegrid.co/contact-us/" target="_blank">here</a>.','profilegrid-user-profiles-groups-and-communities'); */ ?>
              </div>
        ...
        <div class="uimrow">
          ...
          $i=0;
            ...
            <div class="pg-select-theme">
                <img src="<?php echo $themepath[$i].'/theme-image.jpg' ?>" />           
                <input type="radio" name="pm_style" id="style-<?php echo $dirname;?>" value="<?php echo $dirname;?>" <?php checked($dbhandler->get_global_option_value('pm_style','default'),$dirname); ?> />
                <label class="pg-theme-name" for="style-<?php echo $dirname;?>"><?php echo ucfirst($label);?></label>
    ...
    <div class="pg-uim-notice-wrap"><div class="pg-uim-notice"><?php _e('You can also create new templates by copying and renaming "default" folder (&#128194;) inside "[plugin root]/public/partials/themes" to "[your current theme directory]/profilegrid-user-profiles-groups-and-communities/themes".','profilegrid-user-profiles-groups-and-communities');?></div></div>
