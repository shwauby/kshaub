...
class PM_Emails
{
	...
	public function pm_get_email_subject($id,$userid=false,$postid=false,$gid=false)
	{
        ...
        public function pm_send_invite_link($email_id,$gid)
        {
            ...
            $message = sprintf(__("Hello,<br /><br />You have been invited by a %s to join group %s. Please visit this link to sign up:<br /><br /> %s <br /><br /> Regards.","profilegrid-user-profiles-groups-and-communities"),$group_admin_label,$group_name,$registration_url);
