...
class WPPCP_Settings{
    ...
    public function settings(){
        ...
        add_settings_section( 'wppcp_section_wppcp_permissions', __('Bulk Private Page Content','wppcp'), array( &$this, 'wppcp_section_general_desc' ), 'wppcp-general' );
    ...
    public function plugin_options_tabs($type,$tab) {
        ...
        switch($type){
            ...
            case 'general':
                ...
                $this->plugin_settings_tabs['wppcp_section_wppcp_bulk_private_page']  = __('Bulk Private Page Content','wppcp');
                break;
    ...
    public function plugin_options_tab_content($tab,$params = array()){
        ...
        switch($tab){
            ...
            case 'wppcp_section_wppcp_bulk_private_page':                
                // $data = isset($private_content_settings['restriction_permissions']) ? $private_content_settings['restriction_permissions'] : array();
